...
export default function MasterDashboard() {
  ...
  return (
      <>
            ...
            <div className="flex items-center gap-4">
              <div className="flex gap-2">
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded ${activeTab === 'statistics' ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}
                >
                  Статистика
                </button>
                <button
        ...
        <div className="pt-16">
          {activeTab === 'schedule' && <ScheduleWidget masterId={user?.id || ''} />}
          {activeTab === 'statistics' && <MasterStatistics />}
